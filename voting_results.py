...
def generate_vote_visualization():
    # Read the voting data
    with open('inflation-reduction-act/voting_data.json', 'r') as f:
        vote_data = json.load(f)
    
    # Generate the JavaScript for vote visualization
    js_code = """
    ...
    with open('inflation-reduction-act/vote_visualization.js', 'w') as f:
        f.write(js_code)

if __name__ == '__main__':
    generate_vote_visualization() 